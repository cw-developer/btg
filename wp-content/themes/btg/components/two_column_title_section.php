...
$html .= '<section class="two_column_title_section-block '.$customclass.'">';
$html .= '<div class="top_section"><div class="container"><div class="row top_row"><div class="col-lg-6 col-md-12 pe-4">';
...
$html .= '</div></div>';
$html .= '<div class="col-lg-6 col-md-12 ps-lg-4 p-lg-0">';
