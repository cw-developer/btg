...
$html .= '<section class="two_column_title_section-block two_column_title_solutions_section-block '.$customclass.'">';
$html .= '<div class="top_section"><div class="container"><div class="row top_row"><div class="col-lg-5 col-md-6">';
$html .= '<div class="title_content_wrap first_title_box">';
$html .= '<div class="breadcrumbs_wrap">'.get_breadcrumb().'</div>';
$html .= $title_box_1;
$html .= '</div></div>';
$html .= '<div class="col-lg-6 col-md-6 p-lg-0 ps-lg-4">';
...
$html .= '</div></div></div>';
$html .= '<div class="col-lg-7 col-md-6 p-lg-0 ps-lg-4">';
