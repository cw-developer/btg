...
$html .= '<section class="big_text_with_content_section bottom-box-section text-left-animation animation_collection '.$customclass.' '.$animationclass.' content-color-'.$content_color.' align-'.$content_align.' '.$customclass.'" style="background-color: '.$background_color.'"><div class="container"><div class="'.$column_class.'">';
...
$html .= '<div class="content_wrap content_wrap_right">'.$rightcontent.'</div>';
$html .= '</div>';
