...
$html .= '<section class="compliance_and_whistleblowing_section '.$customclass.' '.$animationclass.' content-color-'.$content_color.' align-'.$content_align.'" style="background-color: '.$background_color.'"><div class="container"><div class="'.$column_class.'">';
$html .= '<div class="row"><div class="col-lg-8 pe-5">';
$html .= '<div class="content_wrap">'.$leftcontent.'</div>';
$html .= '</div><div class="col-lg-4">';
foreach($rightcontents as $rightcontent){
$html .= '<div class="content_wrap help_desk_content">'.$rightcontent['content'].'</div>';
}
$html .= '</div>';
