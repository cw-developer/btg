...
<section id="single_banner" class="innerpage_banner">
	<div class="container">
		<div class="row">
			<div class="col-md-9">
								<div class="breadcrumbs_wrap"><ul id="breadcrumbs" class="breadcrumbs"><li class="item-home"><a class="bread-link bread-home" href="https://btgdev.azurewebsites.net" title="Home">Home</a></li><li class="separator separator-home"> / </li><li class="item-cat item-custom-post-type-careers"><a class="bread-cat bread-custom-post-type-careers" href="https://btgdev.azurewebsites.net/careers/" title="Careers">Press Release</a></li></ul></div>
				<h1><?php the_title(); ?></h1>
			</div>
		</div>
	</div>
