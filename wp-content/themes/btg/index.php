...
<section id="innerpage_banner" class="innerpage_banner">
	<div class="container">
		<div class="row">
			...
			<h1><?php if(is_blog()) { echo 'News'; } else { the_archive_title();} ?></h1>
			</div>
		</div>
	</div>
</section>
...
?>
		...
		<h1 class="news_page_content_title"><?php if(is_blog()) { echo 'News'; } else { the_archive_title();} ?></h1>
		</div>
...
if ($wp_query->max_num_pages > 1): 
	echo '<button class="rf_loadmore"><span class="load_more_content">Load More<span><img src="'.site_url().'/wp-content/uploads/2022/07/horizontal-arrow-svg.svg"></span></span></button>';
		endif;
			else:
