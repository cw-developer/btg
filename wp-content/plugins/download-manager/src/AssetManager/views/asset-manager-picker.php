...
?>
    ...
    <head>
        ...
        <style>
            ...
            .btn.btn-xs.btn-simple.btn-success.btn-feature {
                margin-top: 6px;
            }
                                ...
                                <div class="panel-body">
                                    <div class="media well-sm well-file" style="margin: 0;padding: 0">
                                        <div class="pull-right">
                                            <input style="width: 150px;display: inline-block" type="text" class="form-control input-sm" id="__wpdm_filesearch" placeholder="<?= esc_attr__( 'Search File...', WPDM_TEXT_DOMAIN ); ?>" />
                                            <button class="btn btn-primary btn-simple btn-sm ttip" data-placement="bottom" title="Reload" id="reload"><i class="fa fa-sync"></i></button>
                                            <button class="btn btn-primary btn-simple btn-sm ttip" data-placement="bottom" title="Featured Assets" id="btn-featured-assets"><i class="fas fa-star"></i></button>
                ...
                <?php } */ ?>
                            ...
                            <div id="fileTPL" style="display: none">
                                ...
                                <div class="file-row">
                                    <div class="row panel-file file-tpl">
                                        <div class="col-md-11  text-left btn-open-file c-pointer  btn-add-queue" data-filetype="{{contenttype}}" data-path="{{path}}"  data-label="{{item_label}}" data-target="{{path_on}}">
                                        ...
                                        <div class="col-md-1 text-right">
                                            <button class="btn btn-xs btn-simple btn-success btn-feature" type="button" title="Featured" data-oldname="{{item}}" data-path="{{path}}"><i class="{{star}} fa-star"></i></button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <script>
                            ...
                            jQuery(function ($) {
                                ...
                                $("#__wpdm_filesearch").on("keyup", function() {
                                    var value = $(this).val().toLowerCase();
                                    $("#scandir > div").filter(function() {
