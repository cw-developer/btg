...
NOTICE;
    ...
    function updateCore($update_plugins){
        ...
        $item = wpdm_ldetails();
        $urlparts = parse_url(admin_url());
        $domain = strtolower(str_replace("www.", "", wpdm_valueof($urlparts, 'host')));
    ...
    function requestUpdateCheck()
    {
        ...
        $tmpvar = explode("?", basename(__::valueof($_SERVER, 'REQUEST_URI', ['validate' => 'escs'])));
