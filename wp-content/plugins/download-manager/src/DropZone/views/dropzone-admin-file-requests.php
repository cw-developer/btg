...
<div class="panel panel-default">
    <div class="panel-heading">
        <div class="pull-right">
            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#w3eden__bootModal_fs9kvn7w1"><i class="fa fa-file-circle-plus"></i> <?= __('New request', WPDM_TEXT_DOMAIN); ?></button>
        </div>
