                               ...
                               <div class="media">
                                   ...
                                   <div class="ml-3">
                                       <span class="_fsettings">
                                            <a href="#" class="btn btn-sm btn-info _edit_file" data-file="<?= $file->ID ?>"><i class="fa fa-pen-alt"></i></a>
                    ...
                    <div id="drag-drop-area" style="height: auto">
                        <div class="drag-drop-inside" style="padding: 100px 0">
                            <p class="drag-drop-info mb-0">
                                ...
                                <?php _e('Drop files here'); ?></p>
                            <p class="mb-2"><?php _ex('or', 'Uploader: Drop files here - or - Select Files'); ?></p>
                            <p class="drag-drop-buttons"><button id="plupload-browse-button" type="button" class="btn wpdm-vimeo"><?php esc_attr_e('Select Files'); ?></button></p>
                        </div>
                    </div>
                </div>
