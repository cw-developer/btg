                ...
                if(count($__wpdm_social_login) > 1) { ?>
                    <div class="col-sm-12">
                        <div class="text-center card card-default" style="margin: 20px 0 0 0">
                            <?php if(!$_social_only){ ?>
                                <div class="card-header" data-toggle="collapse" href="#socialllogin" role="button" aria-expanded="false" aria-controls="socialllogin"><?php echo isset($params['social_title'])?$params['social_title']:__("Or login using your social account", "download-manager"); ?></div>
                            <?php } else { ?>
                                <div class="card-header"><?php echo isset($params['social_title'])?$params['social_title']:__("Login using your social account", "download-manager"); ?></div>
                            <?php } ?>
