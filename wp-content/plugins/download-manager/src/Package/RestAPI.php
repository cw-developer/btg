...
class RestAPI
{
    ...
    function introduceEndpoints()
    {
        ...
        register_rest_route('wpdm', '/validate-filepass', array(
            'methods' => 'POST',
            'callback' => [new PackageLocks(), 'checkFilePassword'],
            'permission_callback' => '__return_true'
        ));
        ...
        register_rest_route('wpdm', '/facebook-liked', array(
            'methods' => 'POST',
            'callback' => [new PackageLocks(), 'likedOnFacebook'],
            'permission_callback' => '__return_true'
        ));
