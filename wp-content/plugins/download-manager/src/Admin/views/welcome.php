    ...
    <div class="container-fluid" style="margin-top: 10px;max-width: 1200px">
        <div class="row">
            ...
            <div class="col-md-12 lead">
                <hr/>
                <h3>What's New?</h3>
                What new with WordPress Download Manager Pro v6.2.x:
                <hr/>
            </div>

            <div class="col-md-4 r">
                <b>DropZone</b>
                DropZone allows site users to share files with site admin in a easy way.

            </div>
            <div class="col-md-4 r">

                <b>File Request</b>
                Request file from anyone, create custom file request URL just in a few clicks.
