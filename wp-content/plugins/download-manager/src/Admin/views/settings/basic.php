...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="form-group mb-0">
            ...
            <label class="fw-4"><input type="checkbox" name="__wpdm_delete_dfiles" value="1" <?php checked(1, get_option('__wpdm_delete_dfiles')); ?> > <?php echo __("Delete a file when it is detached from a package", "download-manager"); ?></label>
        </div>
        <div class="form-group mb-0">
            <input type="hidden" value="0" name="__wpdm_delete_afiles">
            <label class="fw-4"><input type="checkbox" name="__wpdm_delete_afiles" value="1" <?php checked(1, get_option('__wpdm_delete_afiles')); ?> > <?php echo __("Delete attached files when delete a package", "download-manager"); ?></label>
        </div>
        <div class="form-group mb-0">
