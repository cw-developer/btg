...
<div id="package-settings" class="tab-pane active">
    <table cellpadding="5" id="file_settings_table" cellspacing="0" width="100%" class="table table-bordered table-hover">
        ...
        <tr id="downliad_limit_row">
            ...
            <td><input size="10" style="width: 80px" class="form-control input-sm" type="number" name="file[download_limit_per_user]" value="<?php echo get_post_meta($post->ID,'__wpdm_download_limit_per_user', true); ?>" /> / <?php _e( "user" , "download-manager" ); ?> <i class="info fa-solid fa-circle-info" title="<?php _e( "For non-registered members IP will be taken as ID" , "download-manager" ); ?>"></i><br/>
                <label class="fw-4"><input type="checkbox" name="reset_udl" value="1"> <?php _e( "Reset Limit for All Users" , "download-manager" ); ?></label>
            </td>
        </tr>

        <tr id="view_count_row">
            <td><?php echo __( "View&nbsp;Count:" , "download-manager" ); ?></td>
            <td><input size="10" style="width: 80px" type="number" class="form-control input-sm" name="file[view_count]" value="<?php echo esc_attr(get_post_meta($post->ID,'__wpdm_view_count',true)); ?>" /> <i class="info fa-solid fa-circle-info" title="Set/Reset Download Count for this package"></i></td>
        </tr>

       <tr id="download_count_row">
            <td><?php echo __( "Download&nbsp;Count:" , "download-manager" ); ?></td>
            <td><input size="10" style="width: 80px" type="number" class="form-control input-sm" name="file[download_count]" value="<?php echo esc_attr(get_post_meta($post->ID,'__wpdm_download_count',true)); ?>" /> <i class="info fa-solid fa-circle-info" title="Set/Reset Download Count for this package"></i></td>
        </tr>

       <tr id="package_size_row">
            <td><?php echo __( "Package&nbsp;Size:" , "download-manager" ); ?></td>
            <td><input size="10" style="width: 80px" class="form-control input-sm" type="text" name="file[package_size]" value="<?php echo esc_attr(get_post_meta($post->ID,'__wpdm_package_size',true)); ?>" /> <i class="info fa-solid fa-circle-info" title="Total size of included files with this package."></i></td>
        </tr>
        ...
        <tr id="individual_file_download_row">
            ...
            <td>
                ...
                <div id="eid">
                    ...
                    <i class="info fa-solid fa-circle-info" title="<?php _e( "Enable/Disable single file download from multi-file package" , "download-manager" ); ?>"></i>
                </div>
        ...
        <tr id="cache_zip_row">
            ...
            <td>
                ...
                <div id="eid">
                    ...
                    <i class="info fa-solid fa-circle-info" title="<?php _e( "Do you want to cache the zip file created from attached files" , "download-manager" ); ?>"></i>
                </div>
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        jQuery("#wpdm-settings select").select2({no_results_text: "", width: "50%", minimumResultsForSearch: 6});
